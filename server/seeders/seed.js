...
const composers = [
  'Бах', 'Моцарт', 'Бетховен', 'Шопен', 'Вivaldi', 'Гайдн', 'Шуберт', 'Дебussy',
];
const titles = [
  'Маленькая ночная серенада', 'Лунная соната', 'Экспромт', 'Прелюдия', 'Эtюд',
  'Минuet', 'Сонатина', 'Гамма до мажор', 'Вальс', 'Марш', 'Баркarolla', 'Нокturn',
  'Адажio', 'Сcherzo', 'Рондо', 'Каприс', 'Баллада', 'Фантазия', 'Скerco', 'Полонез',
];
